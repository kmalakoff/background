/**
 ...
 jasmine.getEnv().addReporter(new jasmine.ConsoleReporterHeadless());
...
(function(jasmine, console) {
  ...
  var ConsoleReporterHeadless = function() {
    if (!console || !console.log) { throw "console isn't present!"; }
    this.status = this.statuses.stopped;
  };

  var proto = ConsoleReporterHeadless.prototype;
  proto.statuses = {
    stopped : "stopped",
    running : "running",
    fail    : "fail",
  ...
  proto.reportRunnerResults = function(runner) {
    ...
    this.log("");
    this.log("ConsoleReporterHeadless finished");
  };
  ...
  jasmine.ConsoleReporterHeadless = ConsoleReporterHeadless;
})(jasmine, console);
