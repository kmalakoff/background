...
BGArrayIterator_xN = (function() {
  function BGArrayIterator_xN(arrays, batch_length) {
    ...
    this.reset();
    this.current_range = new BGRange_xN(this.array2_length, this.batch_length);
  }
  BGArrayIterator_xN.prototype.reset = function() {
    this.batch_index = 0;
    return this.batch_count = Math.floor(this.array_combination_count / this.batch_length) + 1;
  };
  BGArrayIterator_xN.prototype.isDone = function() {
    return this.batch_index >= this.batch_count;
  };
  BGArrayIterator_xN.prototype.updateCurrentRange = function() {
  ...
  BGArrayIterator_xN.prototype.step = function() {
    if (this.isDone()) {
      return this.current_range.setIsDone();
    }
    this.batch_index++;
  ...
  BGArrayIterator_xN.prototype.nextByItems = function(fn) {
    ...
    while (!this.current_range.isDone()) {
      fn(this.array1[this.current_ranges[0].index], this.array2[this.current_ranges[1].index], this.current_range, this.array1, this.array2);
