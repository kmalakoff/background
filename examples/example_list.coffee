...
job_list.append(null, (->
  ...
  job_list.append(null, (-> tick_result.push('contrived'); return false) )
  job_list.append(null, (-> tick_result.push('test'); return false) )
  job_list.append(null, (-> alert(tick_result.join(' ')); tick_result=[]; job_list.destroy(); return true) )
  return true)
)
job_list.append(null, (-> alert(tick_result.join(' ')); tick_result=[]; return true) )
